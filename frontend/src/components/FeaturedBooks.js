...
const books = [
  ...
  { 
    ...
    imageUrl: 'https://i.pinimg.com/1200x/13/4c/f6/134cf6f5c279eaf36e0cd380116d89ff.jpg' 
  },
  { 
    title: 'Tỷ phú bán giày', 
    author: 'Tony Hsieh', 
    imageUrl: 'https://i.pinimg.com/1200x/a8/f1/30/a8f13062a2634ee4eafbc5492d0f0f16.jpg' 
  }
];
...
const Arrow = ({ onClick, direction, isVisible }) => {
    ...
    const finalArrowStyle = direction === 'next' 
        ? { ...arrowBaseStyle, right: '-55px' } 
        : { ...arrowBaseStyle, left: '-55px' };
    ...
    return (
        ...
        >
            <span style={{ color: 'white', fontSize: '26px', lineHeight: '0', fontWeight: 'bold' }}>{arrowChar}</span>
        </div>
    );
}
