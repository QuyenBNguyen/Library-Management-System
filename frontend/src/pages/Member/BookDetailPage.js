...
const BookDetailPage = () => {
  ...
  if (loading)
    return (
      <div style={{ textAlign: "center", color: "#543512", margin: "2rem" }}>
    ...
    <div style={styles.pageWrapper}>
      ...
      <div style={styles.detailContainer}>
        ...
        <div style={styles.infoContainer}>
          ...
          <div style={{ ...styles.status, ...getStatusStyle(book.status) }}>
            {book.status}
          </div>
          <div>
            <span style={styles.label}>Genre:</span>
            <span style={styles.value}>{book.genre}</span>
          </div>
          <div>
          ...
          <div>
            ...
            <span style={styles.value}>{book.publisher || "N/A"}</span>
          </div>
          <div>
          ...
          {feedback && (
            <div
              style={{
                ...styles.feedback,
                color: feedback.includes("success") ? "#5cb85c" : "#d9534f",
              }}
            >
              {feedback}
            </div>
